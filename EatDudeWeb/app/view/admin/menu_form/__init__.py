...
categoryForm = CompiledTemplate(categoryForm, 'app\\view\\admin\\menu_form\\categoryForm.html')
...
index = CompiledTemplate(index, 'app\\view\\admin\\menu_form\\index.html')
...
itemForm = CompiledTemplate(itemForm, 'app\\view\\admin\\menu_form\\itemForm.html')
